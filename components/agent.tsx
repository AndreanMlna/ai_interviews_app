...
// Menambahkan interface untuk menangani tipe data dari Vapi Message
...
const Agent = ({
    ...
    // Menghitung lastMessage langsung dari state messages saat render.
    ...
    useEffect(() => {
        ...
        // Memperbaiki tipe data dari 'any' menjadi 'VapiMessage'
